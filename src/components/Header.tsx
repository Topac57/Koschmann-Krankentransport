    ...
    <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 shadow-md backdrop-blur' : 'bg-white/70 backdrop-blur-sm'}`}>
      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        <a href="#" className="flex items-center gap-3" aria-label="Krankenfahrdienst Koschmann Ambulance – Startseite">
          <img src="/assets/logo.jpeg" alt="Logo Krankenfahrdienst Koschmann Ambulance" className="h-14 w-14 rounded-full object-contain ring-2 ring-stone-200" width="56" height="56" />
          <span className="hidden flex-col leading-tight sm:flex"><span className="text-base font-bold tracking-tight text-[#1D1D1F]">Koschmann Ambulance</span><span className="text-xs font-medium uppercase tracking-widest text-[#A80000]">Krankenfahrdienst · Essen und Umgebung</span></span>
        </a>
